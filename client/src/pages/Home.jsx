  ...
  return (
    <div className='min-h-screen bg-[#f3f3f3] flex flex-col'>
        ...
        <div className='max-w-6xl mx-auto'>
          ...
          <div className='flex justify-center mb-6'>
            <div className='bg-gray-100 text-gray-600 text-sm px-4 py-2 rounded-full flex items-center gap-2'>
              <HiSparkles size={16} className="bg-purple-50 text-purple-600" />
          ...
          <div className='text-center mb-28'>
            <motion.h1
              ...
              <span className='relative inline-block'>
                <span className='bg-purple-100 text-purple-600 px-5 py-1 rounded-full'>
                  AI Intelligence
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                <motion.div key={index}
                  ...
                  className={`
        relative bg-white rounded-3xl border-2 border-purple-100 
        hover:border-purple-500 p-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl 
      ...
      `}>
                  ...
                  <div className='absolute -top-8 left-1/2 -translate-x-1/2 bg-white border-2 border-purple-500 text-purple-600 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg'>
                    {item.icon}</div>
          ...
          <div className='mb-32'>
            <motion.h2
              ...
              className='text-4xl font-semibold text-center mb-16'>
              Multiple Interview{" "}
              <span className="text-purple-600">Modes</span>
